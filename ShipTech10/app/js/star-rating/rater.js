...
;(function ($, window){
    ...
    {
        if (!this.settings.readonly || this.settings.readonly)
        {
            if (value < 0)
            {
                value = 0;
    ...
    $.fn.rate.settings = {
        ...
        symbols: {
            utf8_star: {
                base: '<i class="fa fa-star-o fa-lg" style="color: #337AB7;"></i>',
                hover: '<i class="fa fa-star fa-lg" style="color: #337AB7;"></i>',
                selected: '<i class="fa fa-star fa-lg" style="color: #337AB7;"></i>',
            },
            utf8_hexagon: {
                base: '\u2B21',
                hover: '\u2B22',
