/*!
 * Application Insights JavaScript SDK - Web, 2.2.4
        ...
        Sender.prototype.onunloadFlush = function () {
            if ((this._config.onunloadDisableBeacon() === false || this._config.isBeaconApiDisabled() === false) && Util.IsBeaconApiSupported()) {
                try {
                    ...
                    this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.FailedToSendQueuedTelemetry, "failed to flush with beacon sender on page unload, telemetry will not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
                }
            }
            else {
                this.flush();
        ...
        PropertiesPlugin.prototype.processTelemetry = function (event) {
            if (CoreUtils.isNullOrUndefined(event)) ;
                ...
                if (this.context && this.context.user && this.context.user.isNewUser) {
                    ...
                    this._logger.logInternalMessage(exports.LoggingSeverity.CRITICAL, message);
                }
                if (!CoreUtils.isNullOrUndefined(this._nextPlugin)) {
    ...
    var AjaxMonitor = /** @class */ (function () {
        ...
        AjaxMonitor.prototype.initialize = function (config, core, extensions) {
            if (!this.initialized && !this._fetchInitialized) {
                ...
                this._isUsingAIHeaders = this._config.distributedTracingMode === exports.DistributedTracingModes.AI || this._config.distributedTracingMode === exports.DistributedTracingModes.AI_AND_W3C;
                this._isUsingW3CHeaders = this._config.distributedTracingMode === exports.DistributedTracingModes.AI_AND_W3C || this._config.distributedTracingMode === exports.DistributedTracingModes.W3C;
        ...
        AjaxMonitor.prototype.instrumentSetRequestHeader = function () {
            ...
            XMLHttpRequest.prototype.setRequestHeader = function (header, value) {
                try {
                    ...
                    ajaxMonitorInstance._core.logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.FailedMonitorAjaxSetRequestHeader, "Failed to monitor XMLHttpRequest.setRequestHeader, monitoring data for this ajax call may be incorrect.", {
                        ajaxDiagnosticsMessage: AjaxMonitor.getFailedAjaxDiagnosticsMessage(this),
                        exception: Util.dump(e)
                    });
                }
