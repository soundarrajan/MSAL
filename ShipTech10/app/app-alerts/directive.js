...
+(function() {
     ...
     */
    APP_ALERTS.directive('elementDraggable', ['$document', function($document) {
        return {
    ...
    APP_ALERTS.directive('elementDrop', ['$document', function ($document) {
        return {
            link: function(scope, element, attr) {
    ...
    APP_ALERTS.directive('initializeProperty', function () {
        return {
            require: 'ngModel',
