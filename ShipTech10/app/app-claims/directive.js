...
+(function () {
     ...
     */
    APP_CLAIMS.directive('elementDraggable', ['$document', function ($document) {
        return {
    ...
    APP_CLAIMS.directive('elementDrop', ['$document', function ($document) {
        return {
            link: function (scope, element, attr) {
    ...
    APP_CLAIMS.directive('initializeProperty', function () {
        return {
            require: 'ngModel',
