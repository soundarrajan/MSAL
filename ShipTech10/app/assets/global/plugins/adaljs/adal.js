...
//----------------------------------------------------------------------
//    mihait change to support OpenID in AuthenticationContext.prototype._getNavigateUrl
//    any update of the adal.js should implement the same approach in composing the Auth URL
//----------------------------------------------------------------------
  ...
  */
    ...
    */
    ...
    AuthenticationContext.prototype._getNavigateUrl = function (responseType, resource) {
        ...
        var authEndpoint = '/oauth2/authorize';
        if (this.config.authEndpoint) {
            authEndpoint = this.config.authEndpoint;
        }


        var urlNavigate = this.instance + tenant + authEndpoint + this._serialize(responseType, this.config, resource) + this._addLibMetadata();
