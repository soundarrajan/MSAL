angular.module('shiptech.pages')
    .controller('ViewRequestEmailLogController', [ 'API', '$scope', '$element', '$attrs', '$tenantSettings', '$http', '$timeout', '$state', function(API, $scope, $element, $attrs, $tenantSettings, $http,  $timeout, $state) {
        // $timeout(function(){
        let ctrl = this;
