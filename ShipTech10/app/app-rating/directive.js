...
+(function() {
     ...
     */
    APP_RATING.directive('elementDraggable', ['$document', function($document) {
        return {
    ...
    APP_RATING.directive('elementDrop', ['$document', function ($document) {
        return {
            link: function(scope, element, attr) {
    ...
    APP_RATING.directive('initializeProperty', function () {
        return {
            require: 'ngModel',
