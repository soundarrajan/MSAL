...
class ShiptechContractPlanning {
  ...
  {    
    ...
    this.tools.log("Contract Planning");
    result = await this.tools.clickOnItemByText("li.nav-item > a.nav-link > span", 'Contract Planning');
    var page = await this.tools.getPage("Contract Planning", true);
...
module.exports = ShiptechContractPlanning;
