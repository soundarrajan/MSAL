...
class ShiptechAdminRolesList {
  ...
  async NewRole(testCase)
  {    
    testCase.result = true;
    this.tools.log("Loading Admin New Role");
    ...
    result = await this.tools.clickOnItemByText("li.nav-item > a.nav-link[ng-click=\"openInNewTab('url','/admin/role/edit/')\"] > span", 'New Role');
