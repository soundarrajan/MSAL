...
export class ContractDetailsToolbarComponent
  ...
  setNavIds(params: any, navBarList: NavBar) {
    ...
    if (
      ...
      this.contractConfiguration.areTermsAndConditionsAvailable
    ) {
      this.menuItems = [
        {
          label: 'Main Page',
        ...
        },
        {
          ...
          url: parseFloat(contractId)
            ? `${this.baseOrigin}/#/contracts/contract/preview/${contractId}`
            : null,
          routerLinkActiveOptions: { exact: true },
          disabled,
          styleClass: 'tab'
        },
        {
          label: 'Preview Email',
          url: parseFloat(contractId)
            ? `${this.baseOrigin}/#/contracts/contract/email-preview/${contractId}`
            : null,
          routerLinkActiveOptions: { exact: true },
          disabled,
          styleClass: 'tab'
        },
        {
          label: 'Deliveries',
          url: parseFloat(contractId)
            ? `${this.baseOrigin}/#/contracts/contract/productdelivery/${contractId}`
            : null,
          routerLinkActiveOptions: { exact: true },
          disabled,
          styleClass: 'tab'
        },
        {
          label: 'Documents',
          url: parseFloat(contractId)
            ? `${this.baseOrigin}/#/contracts/contract/documents/${contractId}`
            : null,
          routerLinkActiveOptions: { exact: true },
          disabled,
          styleClass: 'tab'
        },
        {
          label: 'Email Log',
          url: parseFloat(contractId)
            ? `${this.baseOrigin}/#/contracts/contract/email-log/${contractId}`
            : null,
          routerLinkActiveOptions: { exact: true },
          disabled,
          styleClass: 'tab'
        },
        {
          label: 'Audit Log',
          url: parseFloat(contractId)
            ? `${this.baseOrigin}/#/contracts/contract/audit-log/${contractId}`
            : null,
          routerLinkActiveOptions: { exact: true },
          disabled,
          styleClass: 'tab'
        ...
        },
        {
          ...
          url: parseFloat(contractId)
            ? `${this.baseOrigin}/#/contracts/contract/terms-conditions/${contractId}`
            : null,
          routerLinkActiveOptions: { exact: true },
          disabled,
          styleClass: 'tab'
