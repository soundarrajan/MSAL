...
export class AuditLogComponent implements OnInit {
  ...
  public loadAuditLog() {
    ...
    let requestPayload = {
      Filters: [
        { ColumnName: 'BusinessId', Value: businessId },
        { ColumnName: 'Transaction', Value: planID }
      ],
  ...
  public columnDefs = [
    {
      ...
      width: 160,
      cellClass: ['font-bold aggrid-content-c']
    },
    {
