...
export class QualityClaimsComponent implements OnInit {
  ...
  // }
  // constructor(public dialog: MatDialog, private controlTowerService: ControlTowerService) {
  ...
  //     headerTooltip: 'Claim Sub-type',
  //     field: 'subType',
  //     width: 120
  //   },

  //   {
  //     headerName: 'Estimated Settlement Amount',
  //     headerTooltip: 'Estimated Settlement Amount',
  //     field: 'amount',
  //     width: 120
  //   },
  //   {
  ...
  // loadQualityClaimsList() {
  //   let requestPayload: any = {"Payload": {
  //     "Order":null,"PageFilters":{"Filters":[]},
  //     "SortList":{
  //       "SortList":[
