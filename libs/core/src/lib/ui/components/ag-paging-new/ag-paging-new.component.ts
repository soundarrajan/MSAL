...
@Component({
  ...
  selector: 'app-ag-paging-new',
  templateUrl: './ag-paging-new.component.html',
  styleUrls: ['./ag-paging-new.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class AgPagingNewComponent implements AfterViewInit {
