  ...
  template: `
    <div class="mchip-container">
      <div [ngClass]="{ 'dashed-border-chip': info.Title === 'Deductions' }">
          ...
          <span style="margin-right: 10px;">
            ...
            >
              <ellipse
                ...
                ry="4"
                fill="#9E9E9E"
                [ngStyle]="{ fill: info.statusColorCode }"
              />
            </svg>
          </span>
          <span>{{ info.Title }}</span>
        ...
        <div
          *ngIf="info.Title === 'Status'"
          class="data cip-container status-container"
          [ngClass]="{ 'tile-2': info.Title === 'Status' }"
          [matTooltip]="info.Data"
          [matTooltipPosition]="'above'"
          matTooltipClass="custom-tooltip"
          [ngStyle]="{ backgroundColor: info.statusColorCode }"
        >
          {{ info.Data }}
        </div>
        <div
          *ngIf="info.Title !== 'Deductions' && info.Title != 'Status'"
          class="data cip-container"
          [ngClass]="{ 'tile-2': info.Title === 'Status' }"
          [matTooltip]="info.Data"
          [matTooltipPosition]="'above'"
          matTooltipClass="custom-tooltip"
        ...
        <div
          *ngIf="info.Title === 'Deductions'"
          class="data deduction-container cip-container"
          [ngClass]="{ 'tile-2': info.Title === 'Status' }"
