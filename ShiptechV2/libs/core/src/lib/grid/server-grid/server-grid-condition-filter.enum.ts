...
export const AgGridConditionTypeToServer: Record<
...
> = {
  ...
  [AgGridConditionTypeEnum.LESS_THAN_OR_EQUAL]:
    ServerGridConditionFilterEnum.LESS_THAN_OR_EQUAL,
  [AgGridConditionTypeEnum.GREATER_THAN]:
    ServerGridConditionFilterEnum.GREATER_THAN,
  [AgGridConditionTypeEnum.GREATER_THAN_OR_EQUAL]:
    ServerGridConditionFilterEnum.GREATER_THAN_OR_EQUAL,
  ...
  [AgGridConditionTypeEnum.NOT_CONTAINS]:
    ServerGridConditionFilterEnum.NOT_CONTAINS,
  [AgGridConditionTypeEnum.STARTS_WITH]:
