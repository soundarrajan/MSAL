...
export class MessageBoxService {
  ...
  public displayDialog<D = any, R = any>(
    config: MatDialogConfig<D> = {},
    componentOrTemplateRef:
      | ComponentType<any>
      | TemplateRef<any> = DefaultDialogComponent
  ): MatDialogRef<any> {
  ...
  public displayConfirmDialog<D = any>(
    config: MatDialogConfig<D> = {},
    componentOrTemplateRef:
      | ComponentType<any>
      | TemplateRef<any> = ConfirmationDialogComponent
  ): MatDialogRef<any> {
    return this.openDialog(componentOrTemplateRef, {
      ...defaultDialogConfig,
      ...config
  ...
  public displayAlertDialog<D = any>(
    config: MatDialogConfig<D> = {},
    componentOrTemplateRef:
      | ComponentType<any>
      | TemplateRef<any> = AlertDialogComponent
  ): MatDialogRef<any> {
    return this.openDialog(componentOrTemplateRef, {
      ...defaultDialogConfig,
      ...config
