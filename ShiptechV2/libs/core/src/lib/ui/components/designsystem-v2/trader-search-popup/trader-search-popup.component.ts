...
@Component({
  selector: 'app-trader-search-popup',
  templateUrl: './trader-search-popup.component.html',
  styleUrls: ['./trader-search-popup.component.css']
})
export class TraderSearchPopupComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<TraderSearchPopupComponent>,
