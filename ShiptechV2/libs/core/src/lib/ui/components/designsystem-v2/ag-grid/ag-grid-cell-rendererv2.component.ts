...
import { SpotnegoAdditionalcostComponent } from "src/app/shiptech-spot-negotiation/spot-negotiation-popups/spotnego-additionalcost/spotnego-additionalcost.component";
import { SpotnegoPricingDetailsComponent } from "src/app/shiptech-spot-negotiation/spot-negotiation-popups/spotnego-pricing-details/spotnego-pricing-details.component";
...
import { SpotnegoRequestChangesComponent } from "src/app/shiptech-spot-negotiation/spot-negotiation-popups/spotnego-request-changes/spotnego-request-changes.component";
...
@Component({
    ...
    <div [ngClass]="params.cellClass" matTooltip="" style="" (click)="sellerratingpopup()">
    <div *ngIf="params.label=='gen-rating'" class="truncate-125 chip"><div>{{params.data.genRating}}<span class="star"></span></div><div>{{params.data.genPrice}}</div></div>
    <div *ngIf="params.label=='port-rating'" class="truncate-125 chip"><div>{{params.data.portRating}}<span class="star"></span></div><div>{{params.data.portPrice}}</div></div>
    </div>
    </div>
    ...
    <!--<div class="remove-icon-cell-hover float-away" (click)='deleteRow();'></div>-->
        ...
        <span class="mail-icon mail-active" (click)="openEmailPreview()" *ngIf="params.data.mail=='mail-active'" matTooltip="View preview email" matTooltipClass="lightTooltip">a</span>
        <span class="mail-icon mail-none" (click)="openEmailPreview()" *ngIf="params.data.mail=='mail-inactive'" matTooltipClass="" matTooltip="">i</span>
        <span class="mail-icon mail-none" (click)="openEmailPreview()" *ngIf="params.data.mail=='mail-none'" matTooltipClass="" matTooltip="">n</span>
   ...
   <!-- <div class="p-tb-5" style="display:flex;align-items:center;">
    ...
    <div *ngIf="params.type=='price-calc'">
        ...
        <div class="price-calc active" style="border:none !important;font-weight: 500;" *ngIf="params.value === '550.00'">
          $ {{params.value}}
        </div>
        ...
        <input class="inputField" [ngModel]="inputValue"  (keydown)="onInputChange($event,params)"  autofocus #inputSection autocomplete="off" name="inputField" 
        ...
        <div class="formulaButton" style="display:inline; position:absolute; left:78px;" (mouseenter)="hoverMenu($event);" [matMenuTriggerFor]="formulamenu" #menuTriggerHover="matMenuTrigger" *ngIf="showFormula"></div>
        </div>
    </div>
    ...
    <div  *ngIf="params.type=='phy-supplier'"> 
        ...
        <div class="phySupplier edit" matTooltip="Add physical supplier" matTooltipClass="lightTooltip" *ngIf="params.value=='Same as seller'"> 
        <span contentEditable=true [matMenuTriggerFor]="clickmenu" #menuTrigger="matMenuTrigger" (click)="editSeller = false">
    ...
    <div *ngIf="!editSeller" class="expansion-popup" style="margin: 20px 0px;">
    ...
    <mat-checkbox [checked]="params.data.check" (click)="$event.stopPropagation();" class="light-checkbox small"  [ngClass]="params.value=='preferred' ? 'darkBorder' : ''"></mat-checkbox>
    </div>
    ...
    <div  *ngIf="params.type=='totalOffer'" class="addTpr defaultAddicon" [matTooltip]="params.value !='-' ? 'includes additional costs' : null" matTooltipClass="lightTooltip" [matMenuTriggerFor]="totalOfferMenupopup" #totalOfferPopupTrigger="matMenuTrigger"  (click)="totalOfferPopupTrigger.closeMenu()" 
    ...
    <div class="add-block" (click)="additionalcostpopup()"><div></div><span>Add additional cost</span></div>
    </mat-menu>
  ...
  <div class='dashed-border-notes'><input matInput [(ngModel)]="docVal" matTooltip="{{docVal}}"></div>
