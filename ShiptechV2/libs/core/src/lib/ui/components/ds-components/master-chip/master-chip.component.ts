...
@Component({
    ...
    template: `
      ...
      <div [ngClass]="{'dashed-border-chip': info.Title === 'Deductions'}" >
          ...
          <div class="data" [ngClass]="{'tile-2': info.Title === 'Status', 'tile-2' : info.Title === 'Estimated Total' || info.Title === 'Total Difference' || info.Title === 'Net Payable', 'tile-2' : info.Title === 'Deductions' }" >{{info.Data}}</div>
        </div>
    </div>
    `,
