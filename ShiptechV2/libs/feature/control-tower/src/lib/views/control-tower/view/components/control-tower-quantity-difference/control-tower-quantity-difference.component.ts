...
export class ControlTowerQuantityDifferenceComponent implements OnInit {
  ...
  private columnDef_aggrid = [
    ...
    {
      headerName: 'Measured ROB',
      headerTooltip: 'Measured ROB',
      field: 'meas_rob',
      width: 120
    },
    {
      headerName: 'Diff. in Qty',
      headerTooltip: 'Diff. in Qty',
      field: 'diff',
      width: 120
    },
    {
  ...
  public rowData_aggrid = [
    {
      ...
      diff: '-54.717',
      uom: 'MT',
      eta: 'Fri 11/02/2021 05:30',
      date: 'Fri 11/02/2021 05:30',
      status: 'New',
      actions: ''
    },
    {
      portCall: '000050001534344',
      vessel: 'CMA CGM A Lincoln',
      port: 'Aarhus',
      type: 'VLSFO',
      email: 'Yes',
  ...
  private columnDef_aggrid1 = [
    ...
    },
    {
      ...
      headerTooltip:
        'Measured Delivery QtyMeaured Delivered Quantity / Survey Report Value',
      field: 'meas_rob',
      width: 120
    },
    {
    ...
    {
      headerName: 'Sum of Or',
      headerTooltip: 'Sum of Or',
      field: 'sum',
      width: 120
    },
    {
