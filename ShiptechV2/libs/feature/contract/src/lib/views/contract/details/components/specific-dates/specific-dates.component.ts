...
export class SpecificDates extends DeliveryAutocompleteComponent
  ...
  removeSpecificDateLine(key) {
    if (this.formValues.pricingScheduleOptionSpecificDate.dates && this.formValues.pricingScheduleOptionSpecificDate.dates[key]) {
      if ( this.formValues.pricingScheduleOptionSpecificDate.dates[key].id) {
        this.formValues.pricingScheduleOptionSpecificDate.dates[key].isDeleted = true;
     } else {
