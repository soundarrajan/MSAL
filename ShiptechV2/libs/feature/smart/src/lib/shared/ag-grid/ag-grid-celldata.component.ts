  ...
  redirectionUrl(params){
    if(params?.colDef?.field){
      ...
      switch(params.colDef.field){
        ...
        case 'ulsfo_estimated_lift' : { if(params.data?.order_id_ulsfo)
        ...
        case 'lsdis_estimated_lift': {  if(params.data?.order_id_lsdis)
        ...
        case 'hsdis_estimated_lift': {  if(params.data?.order_id_hsdis)
