...
export class SmartOperatorComponent implements OnInit {
  ...
  constructor(
    ...
    this.gridOptions = <GridOptions>{
      ...
      onRowClicked: event => {
        let req = {
          vesselView: 'standard-view',
          name: event.data.vesselName,
          id: event.data.vesselId,
          vesselId: event.data.vesselId,
          vesselCode: event.data.vesselCode
        };
        this.localService.setVesselPopupData(req);

        if (
          this.coldefOnClick != 'vesselName' &&
          this.coldefOnClick != 'newrequest'
        ) {
    ...
    this.gridBdnReportOptions = <GridOptions>{
      ...
      overlayNoRowsTemplate: `<span> No Data to Show</span>`,
      onGridReady: params => {
    ...
    this.gridOrderDetailsOptions = <GridOptions>{
      ...
      onGridReady: params => {
        ...
        this.gridOrderDetailsOptions.api.setColumnDefs(
          this.columnDefs_OrderDetails
        );
      },
      onCellClicked: params => {
        this.coldefOnClick = params.colDef.field;
    ...
    this.gridOptions1 = <GridOptions>{
      ...
      onGridReady: params => {
        ...
        this.gridOptions1.api.setColumnDefs(
          this.columnDefs_unmanageablevessels
        );
  ...
  private columnDefs_OrderDetails = [
    ...
    // { headerName: 'Fuel Grade', headerTooltip: 'Fuel Grade', field: 'fuelGrade', width: 100, headerClass: ['aggrid-text-align-c'], cellClass: ['aggrid-content-center']},
    {
      ...
      field: 'fuelGrade',
      cellRendererFramework: AGGridCellDataComponent,
      cellRendererParams: { type: 'order-multiple-values' },
      cellClass: [' aggrid-columgroup-splitter-right aggrid-vertical-center'],
    ...
    },
    {
      ...
      cellRendererParams: function(params) {
        ...
        let newClass =
          params.value === 'Stemmed'
            ? 'custom-chip darkgreen'
            : params.value === 'Confirmed'
            ? 'custom-chip darkblue'
            : params.value === 'Invoiced'
            ? 'custom-chip darkgreen'
            : params.value === 'Delivered'
            ? 'custom-chip darkgreen'
            : params.value === 'Cancelled'
            ? 'custom-chip red'
            : params.value === 'PartiallyInvoiced'
            ? 'custom-chip darkgreen'
            : params.value === 'PartiallyDelivered'
            ? 'custom-chip darkgreen'
            : params.value === 'Inquired'
            ? 'custom-chip purple'
            : '';
        classArray.push(newClass);
    ...
    },
    {
      ...
      width: 100,
      headerClass: ['aggrid-text-align-c'],
      cellClass: ['aggrid-vertical-center']
    },
    {
      headerName: 'SOA',
      headerTooltip: 'SOA',
  ...
  private columnDefs_BdnReport = [
    ...
    },
    {
      ...
      cellClass: ' aggrid-vertical-right'
    },
    {
      ...
      cellRendererParams: params => {
        return {
          type: 'Data-date',
          cellClass: ['custom-chip dark aggrid-space']
        };
      },
      width: 100,
      cellClass: 'aggridlink aggrid-vertical-center'
    }
  ];
  ...
  private columnDefs_myvessels = [
    {
      ...
      cellClass: function(params) {
        var classArray: string[] = ['aggridlink aggrid-vertical-center'];
        let newClass =
          params.data.severity === '3'
            ? 'aggrid-left-ribbon mediumred1'
            : params.data.severity === '2'
            ? 'aggrid-left-ribbon mediumamber'
            : 'aggrid-left-ribbon mediumblue1';
        classArray.push(newClass);
        return classArray.length > 0 ? classArray : null;
      },
      cellRendererFramework: AGGridCellDataComponent,
      cellRendererParams: params => {
        return { type: 'vesselName' };
      }
    },

    {
      headerName: 'Service Code',
      headerTooltip: 'Service Code',
      field: 'serviceCode',
      width: 100,
      cellClass: ' aggrid-vertical-center',
      cellRendererFramework: AGGridCellRendererComponent
    ...
    {
      headerName: 'Next desitination',
      headerTooltip: 'Next destination',
    ...
    },
    {
      ...
      headerClass: ['aggrid-text-align-c'],
      cellClass: ['aggrid-content-center aggrid-columgroup-splitter-right'],
      filter: 'agDateColumnFilter',
      filterParams: {
        suppressAndOrCondition: true,
        comparator: function(
    ...
    },
    {
      ...
      cellRendererParams: function(params) {
        ...
        classArray.push(' aggrid-space');
        let newClass =
          params.value === '120 MT' ? 'bg-yellow p-lr-5 ' : 'inner-box p-lr-5';
        classArray.push(newClass);
        return { cellClass: classArray.length > 0 ? classArray : null };
      }
    },
    {
      ...
      cellRendererParams: function(params) {
        ...
        classArray.push(' aggrid-space');
        let newClass =
          params.value === '120 MT' ? 'bg-red p-lr-5 ' : 'inner-box p-lr-5';
        classArray.push(newClass);
        return { cellClass: classArray.length > 0 ? classArray : null };
      }
    },
    ...
    },
    {
      headerName: 'HSDIS',
      headerTooltip: 'HSDIS',
      field: 'hsdis_current_stock',
      width: 100,
      headerClass: 'aggrid-text-align-c',
      cellClass: [
        'inset-cell aggrid-content-center  aggrid-columgroup-splitter-right'
      ],
      cellRendererFramework: AGGridCellRendererComponent,
      cellRendererParams: function(params) {
        var classArray: string[] = [];
    ...
    },
    {
      ...
      cellRendererParams: {
        type: 'newRequest',
        redirectUrl: `${this.shiptechUrl}/#/new-request`
      }
    }
  ];
  ...
  private columnDefs_unmanageablevessels = [
    {
      ...
      field: 'vesselName',
      width: 100,
      filter: 'text', //cellRendererFramework: AGGridCellRendererComponent,
      cellClass: function(params) {
        var classArray: string[] = [
          'aggridlink aggrid-vertical-center aggrid-left-ribbon mediumred1'
        ];
        return classArray.length > 0 ? classArray : null;
      },
      cellRendererFramework: AGGridCellDataComponent,
    ...
    {
      headerName: 'No of Days Unmanageable',
      headerTooltip: 'No of Days Unmanageable',
      field: 'unmanagedDays',
      width: 150,
      cellClass: 'aggrid-vertical-center'
    }
  ...
  private columnDefs_outstandingrequest = [
    ...
    },
    {
      ...
      headerClass: ['aggrid-text-align-c'],
      cellClass: [
        'aggrid-content-center aggrid-columgroup-splitter-right aggridlink'
      ]
    },
    {
      headerName: 'Port',
    ...
    },
    {
      ...
      field: 'fuelgrade',
      cellRendererFramework: AGGridCellDataComponent,
      cellRendererParams: { type: 'multiple-values' },
      cellClass: [' aggrid-columgroup-splitter-right aggrid-vertical-center'],
      valueGetter: function(params) {
        return params.data.fuelgrade;
      }
  ...
  public rowData3 = [
    {
      requestid: '12819ED',
      service: 'IA4',
      VesselName: 'Maersk Borneo',
      VesselIMONO: '90284727',
      newrequest: 'New Request',
      newreq: 'Physical',
      port: 'Seattle',
      eta: '10/10/2019 10:00',
      etd: '10/10/2019 10:00',
      fuelgrade: ['RMK850'],
      trader: 'Europe Trader',
      operator: 'Macheal Chris',
      status: 'Stemmed',
      serviceid: '271',
      deptid: 'MLAS',
      ownership: 'Chartered',
      destination: 'Marseile',
      nextdestination: 'Catania',
      hsfo: '120 MT',
      vlsfo: '320 MT',
      dogo: ' 450 MT',
      ulsfo: '200 MT',
      datasource: 'Pre Process',
      details: 'Fatal error generated by model',
      noofdays: '3 days',
      retype: 'Trader'
    },
    {
    ...
    },
    {
      ...
      eta: '10/10/2019 10:00',
      etd: '10/10/2019 10:00',
      fuelgrade: ['RMK850', 'RMK5005', 'RMK850', 'RMK850'],
      trader: 'East of Suez',
      operator: 'No Operator',
      status: 'New',
      serviceid: '271',
  ...
  public getBdnReport(FromDelDate, ToDelDate) {
    let req = {
      IsDefaultDate: 1,
      FromDelDate: moment(FromDelDate).format('MM/DD/YYYY'),
      ToDelDate: moment(ToDelDate).format('MM/DD/YYYY')
    };
  ...
  public loadUnmanageableVessels() {
    let requestPayload = '';
    this.localService
      .getUnmanagedVessels(requestPayload)
      .subscribe((data: any) => {
