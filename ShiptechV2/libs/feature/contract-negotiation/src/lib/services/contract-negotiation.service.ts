      ...
      "contractRequestProductOffers": [               
          {
              ...
              "minQuantity": this.tenantService.quantity(data.MinQuantity),
              "maxQuantity": this.tenantService.quantity(data.MaxQuantity),
              "quantityUomId": data.quantityUomId,
              "validityDate": data.ValidityDate,
              "offerPrice": data?.OfferPrice? this.tenantService.liveformat(data?.OfferPrice) : null,
              "pricingTypeId": 1,
              "status": "Inquired",
              "statusId": 2,
              "isSelected": true,
