...
APP_MASTERS.controller("Controller_Datatables", [
    ...
    "$tenantSettings",
    "$listsCache",
    function($scope, $rootScope, $Api_Service, Factory_Labs, $state, $location, $q, $compile, $timeout, $templateCache, Factory_Master, $tenantSettings, $listsCache) {
        var vm = this;
        ...
        $scope.gridOptions = {
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        cellObject: {
                            ...
                            Disabled: "grid.appScope.fVal().formValues.costDetails[grid.appScope.rowIdx(row)].orderAdditionalCostId"
                        }
                    },
                    {
                        name: "product",
                        ...
                        minWidth: 150,
                        cellObject: {
                            Disabled: "grid.appScope.fVal().formValues.costDetails[grid.appScope.rowIdx(row)].orderAdditionalCostId || grid.appScope.fVal().formValues.costDetails[grid.appScope.rowIdx(row)].isTaxComponent",
            ...
            invoiceProductDetails: {
                ...
                columnDefs: [
                    ...
                    // },
                    {
                        ...
                        cellCondition: '!grid.appScope.fVal().formValues.productDetails[grid.appScope.rowIdx(row)].manualPricingDateOverride',
            ...
            labTestResults: {
                ...
                columnDefs: [
                    ...
                    },
                    {
                        name: "qualityMatch.name",
                        displayName: "Passed/Failed",
                        cellTemplate: $scope.dataTableTemplates.passedFailed,
                        width: 150,
                        template: 1
                    },
                    {
            ...
            voyages: {
                data: "formValues.voyages['0'].voyageDetails",
                rowHeight: 40,
                excessRows: 999,
                multiSelect: false,
                noUnselect: true,
            ...
            related_labs: {
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        cellTemplate: $scope.dataTableTemplates.labResultStatus,
                        required: true
                    },
                    {
                        name: "resultDate",
                    ...
                    {
                        name: "reconStatus.displayName",
                        displayName: "Recon Status",
                        cellTemplate: $scope.dataTableTemplates.labReconStatus,
                        required: true,
                    }
                ],
                onRegisterApi: function(api) {
        ...
        $scope.addClaimData = function(obj, spec) {
