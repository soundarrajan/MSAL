...
+(function () {
     ...
     */
    APP_INVOICE.directive('elementDraggable', ['$document', function ($document) {
        return {
    ...
    APP_INVOICE.directive('elementDrop', ['$document', function ($document) {
        return {
            link: function (scope, element, attr) {
    ...
    APP_INVOICE.directive('initializeProperty', function () {
        return {
            require: 'ngModel',
