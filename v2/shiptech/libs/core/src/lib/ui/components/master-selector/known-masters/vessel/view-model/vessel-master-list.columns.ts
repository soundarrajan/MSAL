...
export const VesselMasterListColumnServerKeys: Record<VesselMasterListColumns, string> = {
  ...
  [VesselMasterListColumns.createdBy]: 'createdBy',
  [VesselMasterListColumns.createdOn]: 'createdOn',
  [VesselMasterListColumns.defaultHfo]: 'fuel',
  [VesselMasterListColumns.defaultMgo]: 'distillate',
  [VesselMasterListColumns.defaultUlsfo]: 'lsfo',
  ...
  [VesselMasterListColumns.lastModifiedBy]: 'lastModifiedBy',
  ...
  [VesselMasterListColumns.mgoSpecs]: 'distillateSpecGroup',
  ...
  [VesselMasterListColumns.ulsfoSpecs]: 'lsfoSpecsGroup',
  ...
  [VesselMasterListColumns.hfoSpecs]: 'fuelSpecGroup',
};
