...
export class VesselMastersApi extends ApiServiceBase
  implements IVesselMastersApi {
  @ApiCallUrl()
  ...
  getVessels(request: IVesselMasterRequest): Observable<IVesselMasterResponse> {
    return this.http
      .post<{ payload: IVesselMasterDto[] }>(
        `${this._apiUrl}/${VesselMastersApiPaths.vesselsList}`,
        { payload: request }
      )
      .pipe(
        map(r => ({
  ...
  getVesselPortCalls(
    ...
    return this.http
      .post<IVesselPortCallMasterDto[]>(
        `${this._apiUrl}/${VesselMastersApiPaths.listPortCalls}`,
        { payload: request }
      )
      .pipe(
        map(r => ({
