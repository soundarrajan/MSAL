...
@Component({
  selector: 'app-my-notes-old',
  templateUrl: './my-notes-old.component.html',
  styleUrls: ['./my-notes-old.component.css']
})
export class MyNotesOldComponent implements OnInit {
