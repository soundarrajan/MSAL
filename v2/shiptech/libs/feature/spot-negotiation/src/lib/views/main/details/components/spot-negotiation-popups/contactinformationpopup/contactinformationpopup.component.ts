...
export class ContactinformationpopupComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<ContactinformationpopupComponent>,    @Inject(MAT_DIALOG_DATA) public data: any) { }
  ...
  closeDialog() {
    ...
    tabledata=[
      {"editable": false, name:'Rajat Gupta',designation:'trader',email:'rajagputa@heymail.com', address:'123, HSR Layout',zipcode:'9092019',city:'Chennai',country:'India',mobile:'09283-2932032',phone:'09283-2932032',fax:'09283-2932032',im:'09283-2932032'        
   ...
   // tabledata2=[ ];
    ...
    addNew(tabledata){
          ...
          this.tabledatas3=[
            {name:'',designation:'designation',email:'', address:'',zipcode:'',city:'',country:'',mobile:'',phone:'',fax:'',im:''        
