...
import { QcVesselResponseBunkerStateModel, QcVesselResponseSludgeStateModel } from '../qc-vessel-responses.state';
...
export class UpdateActiveBunkerVesselResponseAction {
  ...
  constructor(public prop: keyof QcVesselResponseBunkerStateModel, public value: unknown) {
  }
